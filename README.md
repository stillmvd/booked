...
Палитра и типографика — только из `brand/brandbook.html` (Cosmic & Vanilla). Свои цвета не
подбирать, тёплые акценты запрещены. Числа макета витрины — из `.planning/research/UX.md`
